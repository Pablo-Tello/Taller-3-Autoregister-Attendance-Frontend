...
import { UserIcon, BookOpenIcon, AcademicCapIcon } from '@heroicons/react/24/outline';
                ...
                <>
                  ...
                  {activeMenu === 'cursos' && (
                    <div>
                      {!selectedCurso ? (
                        <>
                          <h3 className="text-lg font-medium text-gray-900 mb-4">Mis Cursos Matriculados</h3>
                          {secciones2.length > 0 ? (
                              ...
                              {secciones2.map((seccion) => (
                                ...
                                >
                                  <div className="p-4 border-b border-gray-200 bg-blue-50">
                                    <h4 className="font-semibold text-lg text-gray-800">{seccion.str_nombreCurso || seccion.str_idCurso}</h4>
                                  </div>
                                  <div className="p-4">
                            ...
                            <div className="bg-white shadow rounded-lg p-6 text-center">
                              <p className="text-gray-500">No tienes cursos matriculados actualmente.</p>
                            </div>
                          )}
                        </>
                      ) : (
                          ...
                          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                            ...
                            <div className="border-t border-gray-200">
                              {loadingAsistencias ? (
                                ...
                                <div className="text-center py-4">
                                  <p className="text-gray-500">No hay asistencias registradas para este curso</p>
                                </div>
                              )}
                            </div>
                          </div>
